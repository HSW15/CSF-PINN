...
def run(cfg: ModulusConfig) -> None:
    ...
    interior_intersection_3rd_time = interior_mesh_3rd_time & interior_mesh_2nd_time
    interior_intersection_4th_time = interior_mesh_4th_time & interior_mesh_3rd_time
   ...
   # 1st time point
    ...
    inflow_invar = normalize_invar(inflow_invar, center, 1./length_scale_amp, dims=3)
    inflow_outvar = {
       key: value for key, value in inflow_var.items() if key in ["u_2", "v_2", "w_2", "p_2"]
    }
