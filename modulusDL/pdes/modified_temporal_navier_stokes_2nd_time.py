...
class TemporalNavierStokes_2nd(PDE):
    """
    ...
    def __init__(self, nu, rho=1, dim=3, time=True):
        ...
        u_0,v_0,w_0 = Symbol("u_1"), Symbol("v_1"), Symbol("w_1")
        ...
        # velocity componets
        u = Function("u_2")(*input_variables)
        v = Function("v_2")(*input_variables)
        
        if self.dim == 3:
            w = Function("w_2")(*input_variables)
        else:
            w = Number(0)
            w_0 = Number(0)

        # pressure
        p = Function("p_2")(*input_variables)
