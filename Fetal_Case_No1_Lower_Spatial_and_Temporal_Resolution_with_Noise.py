...
from modulusDL.pdes.two_way_couple.modified_temporal_navier_stokes_first_time_lagrange import TemporalNavierStokes_1st_time_lagrange, wall_shear_stress
...
def run(cfg: ModulusConfig) -> None:
    ...
    inflow_var = csv_to_dict(
       to_absolute_path("./temporal_stls/3_time_point_temporal/1072/new_visc_model/US_threshold_with_noise_1072_reduced_res_ccc.csv"))
    inflow_invar = {
       key: value for key, value in inflow_var.items() if key in ["x", "y", "z"]
    }
    inflow_invar = normalize_invar(inflow_invar, center, 1./length_scale_amp, dims=3)
    ...
    # inflow_var = csv_to_dict(
       # to_absolute_path("./temporal_stls/3_time_point_temporal/1082/Doppler_reduced_spatial_res_with_noise_threshold_1082_cc.csv"))
    # inflow_invar = {
       # key: value for key, value in inflow_var.items() if key in ["x", "y", "z"]
    # }
    # inflow_invar = normalize_invar(inflow_invar, center, 1./length_scale_amp, dims=3)
    ...
    inflow_var = csv_to_dict(
       to_absolute_path("./temporal_stls/3_time_point_temporal/1092/new_visc_model/Doppler_reduced_spatial_res_with_noise_threshold_ccccc.csv"))
    inflow_invar = {
       key: value for key, value in inflow_var.items() if key in ["x", "y", "z"]
    }
    inflow_invar = normalize_invar(inflow_invar, center, 1./length_scale_amp, dims=3)
    ...
    interior_pts=interior_mesh_3rd_time.sample_boundary(400000)
    ...
    domain.add_inferencer(openfoam_inferencer, "inf_data_1092_with_wss_wall")
    
    interior_pts=interior_mesh_2nd_time.sample_boundary(400000)
    ...
    domain.add_inferencer(openfoam_inferencer, "inf_data_1082_with_wss_wall")
    
    interior_pts=interior_mesh_pre.sample_boundary(400000)
    ...
    domain.add_inferencer(openfoam_inferencer, "inf_data_1072_with_wss_wall")
    
    inflow_var = csv_to_dict(
       to_absolute_path("./temporal_stls/3_time_point_temporal/1072/export.csv"))
    inflow_invar = {
       key: value for key, value in inflow_var.items() if key in ["x", "y", "z"]
    }
    inflow_invar = normalize_invar(inflow_invar, center, 1./length_scale_amp, dims=3)
    ...
    domain.add_inferencer(openfoam_inferencer, "inf_data_pre_1072_cfd_post_sampled")
    
    inflow_var = csv_to_dict(
       to_absolute_path("./temporal_stls/3_time_point_temporal/1072/new_visc_model/export_plane.csv"))
    inflow_invar = {
       key: value for key, value in inflow_var.items() if key in ["x", "y", "z"]
    }
    inflow_invar = normalize_invar(inflow_invar, center, 1./length_scale_amp, dims=3)
    ...
    domain.add_inferencer(openfoam_inferencer, "plane_1072_pre_vorticity")
